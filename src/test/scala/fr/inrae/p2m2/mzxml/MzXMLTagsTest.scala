...
object MzXMLTagsTest extends TestSuite {
  val tests: Tests = Tests {
    ...
    test("mzXML") {
      ...
      val mzXMLPR: ParseResult[MzXML] = XmlReader.of[MzXML].read(xml)
    ...
    test("msRun") {
      ...
      val msRunPR: ParseResult[MsRun] = XmlReader.of[MsRun].read(xml)
    ...
    test("parentFile") {
      ...
      val parentFilePR: ParseResult[ParentFile] = XmlReader.of[ParentFile].read(xml)
    ...
    test("msInstrument") {
      ...
      val instrumentPR: ParseResult[MsInstrument] = XmlReader.of[MsInstrument].read(xml)
    ...
    test("dataProcessing") {
      ...
      val dataProcessing: ParseResult[DataProcessing] = XmlReader.of[DataProcessing].read(xml)
    ...
    test("scan 1") {
      ...
      val scanPR: ParseResult[ScanOrigin] = XmlReader.of[ScanOrigin].read(xml)
